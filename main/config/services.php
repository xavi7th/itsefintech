...
return [
  ...
  'bleyt' => [
    ...
    'reslove_bank_account_name_endpoint' => env('RESOLVE_BANK_ACCOUNT_NAME_ENDPOINT'),
    'banks_list_endpoint' => env('BANKS_LIST_ENDPOINT'),
    'wallet_to_bank_transfer_endpoint' => env('WALLET_TO_BANK_TRANSFER_ENDPOINT'),
    'wallet_to_wallet_transfer_endpoint' => env('WALLET_TO_WALLET_TRANSFER_ENDPOINT'),
