...
class CardFundingProcessed extends Notification
{
  ...
  public function toMail($card_user)
  {
    ...
    return (new MailMessage)
      ...
      ->line('Your card funding request of ' . to_naira($this->amount) . ' has been processed & is ready for immediate access on your card. For more enquiries, call ' . config('app.phone'));
  }
  ...
  public function toDatabase($card_user)
  {
    ...
    return [
      'action' => to_naira($this->amount) . ' card funding request processed.',
  ...
  public function toSMSSolutions($card_user)
  {
    ...
    return (new SMSSolutionsMessage)
      ->sms_message('Your card funding request of ' . to_naira($this->amount) . ' has been processed & is ready for immediate access on your card. For more enquiries, call ' . config('app.phone'))
      ->to($card_user->phone);
  }
}
