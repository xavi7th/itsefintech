	...
	err => {
		if (err.response) {
			...
			if (err.response.status == 422) {
				...
				var rawErrors = err.response.data.errors || err.response.data.message || err.response.data;
				...
				return
			} else if ((err.response.status == 500 && err.response.data == 'Expired token') || (err.response.status ==
					500 && err.response.data.message == 'Expired token')) {
