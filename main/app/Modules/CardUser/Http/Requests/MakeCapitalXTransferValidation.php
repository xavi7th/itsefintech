 ...
 */
class MakeCapitalXTransferValidation extends FormRequest
{
	/**
	...
	{
		return [
			'customer_email' => 'required|email|exists:card_users,email',
	...
	public function messages()
	{
		return [
			'customer_email' => [
        'required' => 'The login email of the Capital X customer is required',
        'email' => 'Invalid email supplied',
        'exists' => 'Invalid email supplied'
      ]
		];
	}
