 ...
 */
class MakeBankTransferValidation extends FormRequest
{
	/**
	...
	public function messages()
	{
        ...
        'digits' => 'NUBAN account numbers must be 10 digits'
			...
			'account_name' => [
        'required' => 'Account name required. Validate the accountbnumber before proceeding with the bank transfer',
        'max' => 'Account name cannot be more than 200 characters'
      ],
			'sort_code' => [
        ...
        'max' => 'Invalid bank selected'
			...
			'narration' => [
        'required' => 'Enter a transfer description e.g. Payment for new shoes',
        'max' => 'Your narration cannot be more than 100 characters'
      ],
		];
	}
