...
class AccountCreated extends Notification implements ShouldQueue
{
	...
	public function toNexmo($notifiable)
	{
		return (new NexmoMessage)
			->content('Welcome to CapitalX ' . $notifiable->first_name . '. Your account has been created. We will notify you of any updates in your account via SMS. Be good, make money.');
	}
